...
public:    
	...
	*/
    ...
    void BatchFadeAllChildren(TBool aFaded);
	
    void FadeAllChildren( TBool aFaded ); 
	
    void FadeAllChildren( TBool aFaded, TAlfFadeBatch* aFadeBatch, TInt& aIndex ); 

    void FadeCountChanged( TInt aFadeCount ); 
    
    void SetFaded( TBool aFaded, TAlfFadeBatch* aFadeBatch, TInt& aIndex );
