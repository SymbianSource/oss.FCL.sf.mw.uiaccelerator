...
private:
    ...
    // Handles remapping of effects requests. E.g. from embedded effect to regular effect
    void HandleAppFxExceptions(TUid aUid, TInt& aAction, TInt& aType, TInt& aData);
